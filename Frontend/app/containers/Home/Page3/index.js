    ...
    return (
      <div className={classnames(styles.page, styles.page3)} style={{ height: height }}>
        <div className={classnames(styles.standardContent, disIndex == 3 ? '' : styles.out)}>
          ...
          <img src={iStack}  className={styles.iStackBottom} />
          <img src={iStack1}  className={classnames(styles.iStack, styles.iStack1)} />
          <img src={iStack2}  className={classnames(styles.iStack, styles.iStack2)} />
          <img src={iStack3}  className={classnames(styles.iStack, styles.iStack3)} />
          <img src={iStack4}  className={classnames(styles.iStack, styles.iStack4)} />
          <div className={styles.iAppends}>
            <img src={round1}  className={classnames(styles.iAppendBlue, styles.iAppend1)} />
            <img src={round2}  className={classnames(styles.iAppendBlue, styles.iAppend2)} />
            <img src={round3}  className={classnames(styles.iAppendBlue, styles.iAppend3)} />
          </div>
          {content}
        </div>
      </div>
